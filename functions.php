...
add_image_size( 'page_thumbnail', 100, 0, false );
add_image_size( 'feature_image', 1100, 0, false );

add_image_size( 'list_image', 250, 250, true );
add_image_size( 'rcol-image', 450, 0, false );

add_image_size( 'gallery-thumb', 600, 0, false );
add_image_size( 'lcol_image', 900, 0, false );
add_image_size( 'wide_single', 1400, 0, false );
add_image_size( 'owl_slide', 1200, 800, true );
add_image_size( 'feature_image', 1100, 600, true );
